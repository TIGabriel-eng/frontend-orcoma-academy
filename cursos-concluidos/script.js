/* ============================================================
   ORCOMA ACADEMY — JavaScript (Cursos Concluídos)
   ============================================================ */
...
function initSidebarNav() {
  ...
  navItems.forEach(function (item) {
    item.addEventListener("click", function () {
      ...
      else if (page === "concluidos") return; // already on this page
...
document.addEventListener("DOMContentLoaded", function () { initEnvSelector(); initSidebarNav(); initSidebarMobile(); initCourseCards(); });
